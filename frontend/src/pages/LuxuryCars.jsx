      ...
      <div className="container">
        <div className="cars-content">
          ...
          <div className="results-summary">
            <h3>{filteredCars.length} Luxury Vehicles Available</h3>
            <p>
            ...
            <section className="cars-section">
              <div className="section-head">
                <div className="section-title">
                  <h2>Curated Premium Fleet</h2>
                  <p>Designed for business travel, events, and memorable drives.</p>
                </div>
                <div className="section-badges" aria-label="Luxury Vehicles summary">
              ...
              {renderSectionGrid(filteredCars, 'Luxury Vehicles')}
            </section>
          )}
        </div>
      </div>
